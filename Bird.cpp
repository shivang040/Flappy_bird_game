...
namespace game
{
    Bird::Bird(GameDataRef data):_data(data)
    {
        ...
        _birdSprite.setPosition((this->_data->window.getSize().x/4)-(_birdSprite.getGlobalBounds().width/2),(this->_data->window.getSize().y/2)-(_birdSprite.getGlobalBounds().height/2));
